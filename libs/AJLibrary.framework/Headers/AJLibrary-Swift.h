...
- (void)BatterySingleWakeUp:(NSString * _Nonnull)deviceId deviceMode:(NSString * _Nonnull)deviceMode vendorCode:(NSString * _Nonnull)vendorCode complete:(void (^ _Nonnull)(SuccessResultModel * _Nullable, ErrorModel * _Nullable))complete;
